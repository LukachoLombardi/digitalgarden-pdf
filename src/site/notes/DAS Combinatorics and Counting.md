...
Some combinatorial proof examples regarding the binomial coefficient and powersets: [Lecture_6, p.19-1](/img/user/Attachments/Lecture_6.pdf)
...
Double counting enables us to transform a logical relation between two sets we know about into an equation between the degrees, which can allow us to find formulas or prove ones set up as theses. (Although kind of incomplete, this is a good example: [Lecture_7, p.6-1](/img/user/Attachments/Lecture_7.pdf)).
